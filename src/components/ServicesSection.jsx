  ...
  },
  {
    ...
    packages: [
      ...
      },
      {
        ...
        recommend: 'Freelancers & Creatives',
      },
      {
        tier: 'Business',
        badge: '💼',
        ...
        recommend: 'Small & Medium Businesses',
      },
      {
        tier: 'Premium',
        badge: '⭐',
      ...
      },
      {
        ...
        recommend: 'Online Stores & Retail',
      },
      {
        tier: 'Movie Clone',
        badge: '🎬',
        price: '₹49,999+',
        features: [
          'Movie / Streaming Platform Clone',
          ...
          'Payment Gateway Integration',
          '24/7 Priority Support',
          '60 Days After-Delivery Support',
          'Source Files Included',
        ],
        recommend: 'Streaming Startups',
      },
      {
        tier: 'Custom App',
        badge: '⚡',
        ...
        features: [
          ...
          '90 Days After-Delivery Support',
          'Source Files & Documentation',
        ],
        recommend: 'Businesses & Enterprises',
      },
    ],
  },
  {
                  ...
                  <div className="mt-auto space-y-3 border-t border-[#e0e0e0] pt-4">
                    {s.packages.map((pkg) => (
                      <div
                        ...
                        className="flex items-center justify-between cursor-pointer hover:bg-[#f5f5f7] rounded-lg px-2 -mx-2 py-2.5 transition-colors"
                      >
                        <div>
